...
db_full_backup()
	{	
		...
		mysqldump  -uroot -paecsqlyou  --master-data=2 --flush-logs -x --add-drop-database --databases pcbcmf budget ecshop pcwcms pc pcwb2bs b2bsite minicmf minimarket > ${SRC_DB_FULL}/pcw-ecshop-${CUR_DATE}.sql
