...
db_full_backup()
	{	
		...
		mysqldump  -uroot -paecsqlyou  --master-data=2 --flush-logs -x --add-drop-database --databases ecshop pcwcms pc pcwb2bs b2bsite  > ${SRC_DB_FULL}/pcw-ecshop-${CUR_DATE}.sql
